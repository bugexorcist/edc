    ...
    <div class="fileedit-sub">
        ...
        <form action="" method="post">
            <div class="alignleft">
                ...
                <input id="old_domain" size="50" name="old_domain" <?php echo (array_key_exists('old_domain', $_POST))?' value="' . $_POST['old_domain'] . '"':''; ?>/>
            ...
            <div class="alignleft">
                ...
                <input id="new_domain" size="50" name="new_domain" <?php echo (array_key_exists('new_domain', $_POST))?' value="' . $_POST['new_domain'] . '"':''; ?>/>
